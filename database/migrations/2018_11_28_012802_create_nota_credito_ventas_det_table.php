...
class CreateNotaCreditoVentasDetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nota_credito_ventas_det', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('nota_credito_cab_id')->references('id')->on('nota_credito_ventas_cab');
        });
    }
    ...
    {
        Schema::dropIfExists('nota_credito_ventas_det');
    }
}
