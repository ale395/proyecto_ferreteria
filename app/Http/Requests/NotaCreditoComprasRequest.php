...
class NotaCreditoComprasRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        switch($this->method())
        {
            ...
            {
                return [
                    'nro_nota_credito'=>'required|unique_with:compras_cab,proveedor_id,timbrado', 
                    'timbrado'=>'required', 
            ...
            {
                return [
                    'nro_nota_credito'=>'required|unique_with:compras_cab,proveedor_id,timbrado,'.$this->id, 
                    'timbrado'=>'required',
                    'proveedor_id'=>'required', 
                    'moneda_id'=>'required',
                    'fecha_emision'=>'required',
    ...
    {
        return [
            'nro_nota_credito.required' => 'Ingrese el número del comprobante.',
            'nro_nota_credito.unique' => 'Comprobante ya existe.',
