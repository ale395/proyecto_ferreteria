...
@section('content')
  ...
  <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Lista de Tipos de Proveedores
                        @can('tiposproveedores.create')
                ...
                <div class="panel-body">
                    <table id="tipo-proveedor-table" class="table table-striped table-responsive">
                        <thead>
                            <tr>
                                <th>Codigo</th>
                                <th>Nombre</th>
    ...
    @include('tiposproveedores.form')
@endsection

@section('ajax_datatables')
  <script type="text/javascript">
      var table = $('#tipo-proveedor-table').DataTable({
                      language: { url: 'datatables/translation/spanish' },
                      processing: true,
                      serverSide: true,
                      ajax: "{{ route('api.tiposproveedores') }}",
                      columns: [
      ...
      function addForm() {
        ...
        $('.modal-title').text('Nuevo Tipo de Proveedor');
      }
      ...
      $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('tiposproveedores') }}";
                    else url = "{{ url('tiposproveedores') . '/' }}" + id;
      ...
      function editForm(id) {
        ...
        $('#error-block').hide();
        $.ajax({
          url: "{{ url('tiposproveedores') }}" + '/' + id + "/edit",
          type: "GET",
          dataType: "JSON",
          success: function(data) {
            $('#modal-form').modal('show');
