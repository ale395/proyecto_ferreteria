        ...
        <form method="post" action="{{action('EmpleadoController@store')}}" class="form-horizontal form-label-left" data-toggle="validator">
            <div class="panel panel-default">
                ...
                <div class="col-xs-10">
                    ...
                    <div class="form-group">
                        <label for="nro_cedula" class="col-xs-2 control-label">Nro CI*</label>
                        <div class="col-xs-3">
                    ...
                    <div class="form-group">
                        <label for="apellido" class="col-xs-2 control-label">Apellido*</label>
                        <div class="col-xs-5">
                    ...
                    <div class="form-group">
                        <label for="correo_electronico" class="col-xs-2 control-label">Correo Elect.*</label>
                        <div class="col-xs-5">
                    ...
                    <div class="form-group">
                        <label for="telefono_celular" class="col-xs-2 control-label">Tel. Celular*</label>
                        <div class="col-xs-4">
                        ...
                        <label for="fecha_nacimiento" class="col-xs-2 control-label">Fecha Nac.*</label>
                        <div class="col-xs-2">
                    ...
                    <div class="form-group">
                        <label for="tipo_empleado" class="col-xs-2 control-label">Tipo Empleado*</label>
                        <div class="col-xs-5">
                ...
                <div class="col-xs-2">
                    <img src="{{ URL::to('/') }}/images/user.jpg" alt="..." class="img-responsive" width="100" height="100">
                    <h5></h5>
