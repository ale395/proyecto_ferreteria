            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" id="codigo_establecimiento" name="codigo_establecimiento" class="form-control" value="{{old('codigo_establecimiento', $empresa->codigo_establecimiento)}}" placeholder="Código asignado por la SET" autofocus>
                        </div>
                    </div>
                    <div class="form-group">
