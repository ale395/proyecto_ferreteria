            ...
            <form id="cotizacion-form" method="post" class="form-horizontal" data-toggle="validator">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" id="fecha" name="fecha" class="form-control" autofocus>
                    ...
                    <div class="form-group">
                        <label for="valor_venta" class="col-md-2 control-label">Valor_Venta</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <label for="moneda_id" class="control-label col-md-1">Moneda *</label>
                        <div class="col-md-4">
                            <select name="moneda_id" id="select2-zonas" class="form-control" style="width: 100%">
                                <option></option>
                                @foreach($monedas as $id => $monedaa)
