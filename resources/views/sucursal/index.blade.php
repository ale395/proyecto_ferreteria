        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table id="sucursal-table" class="table table-striped table-responsive">
                        <thead>
                            <tr>
                                <th>Codigo</th>
                                <th>Nombre</th>
...
@section('ajax_datatables')
	<script type="text/javascript">
      var table = $('#sucursal-table').DataTable({
                      language: { url: 'datatables/translation/spanish' },
                      processing: true,
                      serverSide: true,
                      ajax: "{{ route('api.sucursales') }}",
                      columns: [
      ...
      $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('sucursales') }}";
                    else url = "{{ url('sucursales') . '/' }}" + id;
...
@section('otros_scripts')
  ...
  <script type="text/javascript">
    $('#sucursal-form').validator().off('input.bs.validator change.bs.validator focusout.bs.validator')
  </script>
@endsection
