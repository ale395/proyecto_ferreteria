...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form method="post" action="{{action('ReportesMovimientosController@verReporteMovimientos')}}" class="form-horizontal" data-toggle="validator">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Reporte de Movimientos aritculo - Filtros</h4>
                </div>
