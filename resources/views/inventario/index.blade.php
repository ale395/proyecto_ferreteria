        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Lista de Inventarios
                        @can('inventarios.create')
                          <a onclick="window.location='{{route('inventarios.create')}}'" class="btn btn-primary pull-right" style="margin-top: -8px;"><i class="fa fa-plus-circle" aria-hidden="true"></i> Agregar</a>
                        @else
                ...
                <div class="panel-body">
                    <table id="pedidos-table" class="table-striped table-responsive row-border" style="width:100%">
                        <thead>
                            <tr>
                                <th width="100">Nro Inventario</th>
                                <th>Fecha</th>
                                <th>Sucursal</th>
...
@section('ajax_datatables')
  <script type="text/javascript">
      ...
      function showForm(id) {
        window.location="{{ url('inventarios') }}" + '/' + id;
      }

      function editForm(id) {
        window.location="{{ url('inventarios') }}" + '/' + id +'/edit';
      }
